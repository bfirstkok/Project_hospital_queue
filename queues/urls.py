...
urlpatterns = [
    ...
    path("emergency-transfers/<int:visit_id>/accept/", capability_required(Capability.MANAGE_EMERGENCY)(views.accept_emergency_case), name="accept_emergency_case"),
    path("emergency-transfers/<int:visit_id>/discharge/", capability_required(Capability.MANAGE_EMERGENCY)(views.discharge_emergency_case), name="discharge_emergency_case"),
    path("emergency-transfers/<int:visit_id>/refer/", capability_required(Capability.MANAGE_EMERGENCY)(views.refer_emergency_case), name="refer_emergency_case"),
