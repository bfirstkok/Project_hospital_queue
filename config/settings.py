...
PATIENT_AUTH_RATE_LIMIT = int(os.getenv("PATIENT_AUTH_RATE_LIMIT", "5"))
PATIENT_AUTH_RATE_WINDOW = int(os.getenv("PATIENT_AUTH_RATE_WINDOW", "60"))
...
MIDDLEWARE = [
    ...
    'accounts.middleware.SuperuserRoleSimulationMiddleware',
    'queues.middleware.StaffActivityMiddleware',
